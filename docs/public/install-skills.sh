...
primary_url="https://raw.githubusercontent.com/tina4stack/tina4/main/install-skills.sh"
mirror_url="https://cdn.jsdelivr.net/gh/tina4stack/tina4@main/install-skills.sh"
