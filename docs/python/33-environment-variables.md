...
This is a quick-reference for the 20 most important `.env` variables in Tina4 Python. For the complete reference of all 82 variables, see **Book 0: Understanding Tina4, Chapter 4**.
