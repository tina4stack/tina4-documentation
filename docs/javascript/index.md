...
| Module | Raw | Gzipped |
|--------|-----|---------|
| Core (signals + html + component) | 7.7 KB | 2.44 KB |
| Router | 2.6 KB | 1.13 KB |
| API | 1.8 KB | 0.82 KB |
| PWA | 3.0 KB | 1.13 KB |
| **Full framework** | **15.1 KB** | **5.52 KB** |

Tree-shakeable — import only what you need:
```ts
import { signal, html } from 'tina4js/core';    // 2.44 KB gzip
import { route, router } from 'tina4js/router';  // 1.13 KB gzip
import { api } from 'tina4js/api';                // 0.82 KB gzip
import { pwa } from 'tina4js/pwa';                // 1.13 KB gzip
```
