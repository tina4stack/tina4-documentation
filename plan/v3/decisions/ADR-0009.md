...
`plan/v3/features/047-frond-lexer.md`,
`plan/v3/features/048-frond-parser.md`,
`plan/v3/features/049-frond-compiler.md` and
`plan/v3/features/050-frond-runtime.md`, where the split is a prerequisite for
