...
**Date:** 2026-08-01
**Status:** Accepted
**Context:** Feature 88 (queue backends), `plan/v3/features/088-queue.md`
...
- Python moved first and is currently ahead of PHP, Ruby and Node on these three
  ...
  `plan/v3/features/088-queue.md` and closing it is the follow-up.
