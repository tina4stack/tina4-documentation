...
**Context:** Feature 31 (router and dispatch), follow-on. Surfaced by the Feature 38 (health check) audit.
...
The Feature 38 audit found a Ruby app serving its CMS catch-all on `/__health`.
...
real-world frameworks), and `plan/v3/features/031-router-and-dispatch.md`.
---
