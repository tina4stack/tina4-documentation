...
**Date:** 2026-07-31
**Status:** Accepted
**Context:** Feature 30 (router and dispatch), global middleware ordering
...
(see `plan/v3/features/030-router-and-dispatch.md`).
...
`plan/v3/features/030-router-and-dispatch.md`.
