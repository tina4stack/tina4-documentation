...
**Date:** 2026-07-31
**Status:** Accepted
**Context:** Feature 31 (router and dispatch), global middleware ordering
...
(see `plan/v3/features/031-router-and-dispatch.md`).
...
`plan/v3/features/031-router-and-dispatch.md`.
