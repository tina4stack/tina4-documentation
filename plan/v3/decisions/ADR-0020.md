...
**Date:** 2026-08-01
**Status:** Accepted
**Context:** Feature 71 (cache backends), Features 58 and 59 (template and
fragment caching)
...
That ordering belongs to feature 30 and ADR-0019 and is filed there with the
...
**Related:** ADR-0012, ADR-0019, and `plan/v3/features/071-cache-interface.md`.
