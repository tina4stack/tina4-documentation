...
**Date:** 2026-08-01
**Status:** Accepted
**Context:** Features 34 (rate limiter), 29 (response types), 31 (route groups)
...
- `X-RateLimit-Reset` is an absolute Unix timestamp in PHP, Ruby and Node, and
  ...
  **Python remains the outlier and is NOT changed here** - see the difference
  table in `plan/v3/features/034-rate-limiting.md`.

**Related:** ADR-0012 (settle a contract against real-world frameworks),
ADR-0015 (route precedence), and
`plan/v3/features/034-rate-limiting.md`,
`plan/v3/features/029-response-types.md`,
`plan/v3/features/114-cli-routes.md` and
`plan/v3/features/031-route-groups.md`.
