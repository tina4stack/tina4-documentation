...
**Date:** 2026-08-01
**Status:** Accepted
**Context:** Features 35 (rate limiter), 30 (response types), 32 (route groups)
...
- `X-RateLimit-Reset` is an absolute Unix timestamp in PHP, Ruby and Node, and
  ...
  **Python remains the outlier and is NOT changed here** - see the difference
  table in `plan/v3/features/035-rate-limiting.md`.

**Related:** ADR-0012 (settle a contract against real-world frameworks),
ADR-0015 (route precedence), and
`plan/v3/features/035-rate-limiting.md`,
`plan/v3/features/030-response-types.md`,
`plan/v3/features/115-cli-routes.md` and
`plan/v3/features/032-route-groups.md`.
