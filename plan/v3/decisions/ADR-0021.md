...
**Date:** 2026-08-01
**Status:** Accepted
**Context:** Features 64 (JWT) and 65 (session handling)

### Context

The legacy Features 41/42 audit, now Features 64/65, measured all four implementations from source and then
...
change belongs to feature 24/20 and is owned by ADR-0020; this audit supplies
...
`plan/v3/features/064-jwt-authentication.md` and
`plan/v3/features/065-session-handling.md`.
