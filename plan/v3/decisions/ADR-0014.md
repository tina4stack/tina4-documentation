...
**Date:** 2026-07-31
**Status:** Accepted
**Context:** Feature 32 (middleware pipeline), return-value handling and hook scope
...
- **Not decided here, deliberately:** the after pass runs in REGISTRATION order
  ...
  `plan/v3/features/032-middleware-pipeline.md`.

**Related:** ADR-0012, and `plan/v3/features/032-middleware-pipeline.md`.
---
