...
**Date:** 2026-07-31
**Status:** Accepted
**Context:** Feature 39 (graceful shutdown), signal handling in all four frameworks
...
**Related:** ADR-0012, and `plan/v3/features/039-graceful-shutdown.md`.
...
| Framework | production server | Feature 39 contract |
| --- | --- | --- |
...
**The Feature 39 OUTCOMES are the framework's contract regardless of which
...
- The headline measurement table in
  `plan/v3/features/039-graceful-shutdown.md` is labelled as built-in-path for
