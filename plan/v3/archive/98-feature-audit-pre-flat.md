...
| --- | --- | --- | --- | --- | --- |
| 87 | Messenger (historical audit pilot) | SYNTHESISE | correctness | `features/087-email-messenger.md` | **SHIPPED all 4**, 0 open under the original pilot; queued for the adversarial re-audit in numeric order (py `9075423`, php `721aba94`, node `c96ba9f`, ruby `33b25de`) |
...
See `features/057-sandboxing.md`. **Owner decision: taken, and shipped.**
