# Feature 012: ODBC provider

## Identity and status

- Matrix identity: 12 — ODBC provider
- Audit state: queued
...
This feature gives an application one portable odbc provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for ODBC provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/database/odbc.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
