# Feature 126: Development error overlay

## Identity and status

- Matrix identity: 126 — Development error overlay
- Audit state: queued
...
This feature gives an application one portable development error overlay contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Development error overlay. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/debug/error_overlay.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
