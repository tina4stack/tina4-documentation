# Feature 123: CLI guided setup

## Identity and status

- Matrix identity: 123 — CLI guided setup
- Audit state: queued
...
- Catalog phase: Unified CLI

## Why this feature exists

This feature gives an application one portable cli guided setup contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI guided setup. The
...
| --- | --- | --- | --- | --- |
| Public surface | `delegated by tina4_python/cli/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
