# Feature 121: CLI command discovery and help

## Identity and status

- Matrix identity: 121 — CLI command discovery and help
- Audit state: queued
...
This feature gives an application one portable cli command discovery and help contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI command discovery and help. The
