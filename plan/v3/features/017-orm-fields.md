# Feature 017: ORM fields and column mapping

## Identity and status

- Matrix identity: 17 — ORM fields and column mapping
...
Feature 16's D4 deferred this decision here: `camelToSnake` (PHP), `auto_map` /
