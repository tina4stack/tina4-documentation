# Feature 008: PostgreSQL provider

## Identity and status

- Matrix identity: 8 — PostgreSQL provider
- Audit state: queued
...
This feature gives an application one portable postgresql provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for PostgreSQL provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/database/postgres.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
