...
- Dependencies: Features 48-50 and the Feature 72 cache-provider contract

Feature 59 owns compiled-template cache identity, freshness, invalidation,
development behavior, concurrency and bounds. It does not own fragment output
caching (Feature 60), general KV backends (Feature 72) or HTTP response caching.
