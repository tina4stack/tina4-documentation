# Feature 048: Frond parser

## Identity and status

- Matrix identity: 48 — Frond parser
...
- Historical audit: 2026-07-28, previously bundled with Features 47, 49 and 50

## Why this feature exists

The parser turns the lexer token stream into one portable Frond syntax tree.

## Boundary

Feature 48 owns deterministic conversion from Feature 47 tokens into an AST,
including precedence, nesting, source spans and parse errors. It does not own
tokenization, executable generation, runtime context or filters.
...
Only Python exposed a recognizable parser boundary in the historical audit.
PHP, Ruby and Node mixed parsing with compilation or evaluation.
