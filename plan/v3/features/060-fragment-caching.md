...
- Historical evidence was mixed into the Feature 72 cache-backend audit
- Dependencies: Feature 51 runtime and Feature 72 cache providers

Feature 60 owns fragment key construction, TTL semantics, rendered-fragment
storage and invalidation. It does not own compiled-template caching (Feature 59)
or the provider's generic KV contract (Feature 72).
