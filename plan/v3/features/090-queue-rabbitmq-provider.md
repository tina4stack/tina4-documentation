# Feature 090: RabbitMQ queue provider

## Identity and status

- Matrix identity: 90 — RabbitMQ queue provider
- Audit state: queued
...
- Catalog phase: Queue providers

## Why this feature exists

This feature gives an application one portable rabbitmq queue provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for RabbitMQ queue provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/queue/rabbitmq_backend.py; tina4_python/queue_backends/rabbitmq_backend.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
