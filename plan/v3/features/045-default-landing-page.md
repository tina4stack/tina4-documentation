# Feature 045: Default landing page

## Identity and status

- Matrix identity: 45 — Default landing page
- Audit state: queued
...
This feature gives an application one portable default landing page contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Default landing page. The
