# Feature 106: HTML element builder

## Identity and status

- Matrix identity: 106 — HTML element builder
- Audit state: queued
...
This feature gives an application one portable html element builder contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for HTML element builder. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/HtmlElement.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
