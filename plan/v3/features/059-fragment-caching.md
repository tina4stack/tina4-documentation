# Feature 059: Frond fragment caching

## Identity and status

- Matrix identity: 59 — Frond fragment caching
...
- Historical evidence was mixed into the Feature 71 cache-backend audit
- Dependencies: Feature 50 runtime and Feature 71 cache providers

Feature 59 owns fragment key construction, TTL semantics, rendered-fragment
storage and invalidation. It does not own compiled-template caching (Feature 58)
or the provider's generic KV contract (Feature 71).
