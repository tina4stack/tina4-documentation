# Feature 123: CLI doctor

## Identity and status

- Matrix identity: 123 — CLI doctor
- Audit state: queued
...
This feature gives an application one portable cli doctor contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI doctor. The
