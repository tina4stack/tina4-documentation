# Feature 046: In-process background tasks

## Identity and status

- Matrix identity: 46 — In-process background tasks
- Audit state: queued
...
This feature gives an application one portable in-process background tasks contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for In-process background tasks. The
