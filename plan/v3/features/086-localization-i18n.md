# Feature 086: Localization and i18n

## Identity and status

- Matrix identity: 86 — Localization and i18n
- Audit state: queued
...
This feature gives an application one portable localization and i18n contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Localization and i18n. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/i18n/__init__.py; tina4_python/translations/` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
