# Feature 096: MongoDB document store provider

## Identity and status

- Matrix identity: 96 — MongoDB document store provider
- Audit state: queued
...
- Catalog phase: Document storage providers

## Why this feature exists

This feature gives an application one portable mongodb document store provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for MongoDB document store provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/docstore/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
