# Feature 021: Imperative ORM relationships

## Identity and status

- Matrix identity: 21 — Imperative ORM relationships
- Audit state: queued
...
This feature gives an application one portable imperative orm relationships contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Imperative ORM relationships. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/orm/model.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
