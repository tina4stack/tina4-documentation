# Feature 082: WebSocket protocol and server

## Identity and status

- Matrix identity: 82 — WebSocket protocol and server
- Audit state: queued
...
This feature gives an application one portable websocket protocol and server contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for WebSocket protocol and server. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/websocket/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
