# Feature 010: MSSQL provider

## Identity and status

- Matrix identity: 10 — MSSQL provider
- Audit state: queued
...
This feature gives an application one portable mssql provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for MSSQL provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/database/mssql.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
