# Feature 132: Carbonah benchmark contract

## Identity and status

- Matrix identity: 132 — Carbonah benchmark contract
- Audit state: queued
...
- Catalog phase: Verification tools

## Why this feature exists

This feature gives an application one portable carbonah benchmark contract contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Carbonah benchmark contract. The
...
| --- | --- | --- | --- | --- |
| Public surface | `benchmarks/ and plan/v3/CARBONAH.md` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
