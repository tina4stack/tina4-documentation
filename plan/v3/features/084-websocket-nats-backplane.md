# Feature 084: NATS WebSocket backplane

## Identity and status

- Matrix identity: 84 — NATS WebSocket backplane
- Audit state: queued
...
This feature gives an application one portable nats websocket backplane contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for NATS WebSocket backplane. The
