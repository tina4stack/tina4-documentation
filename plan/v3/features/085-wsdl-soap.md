# Feature 085: WSDL and SOAP

## Identity and status

- Matrix identity: 85 — WSDL and SOAP
- Audit state: queued
...
This feature gives an application one portable wsdl and soap contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for WSDL and SOAP. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/wsdl/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
