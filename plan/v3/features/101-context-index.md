# Feature 101: Local source and documentation context index

## Identity and status

- Matrix identity: 101 — Local source and documentation context index
- Audit state: queued
...
This feature gives an application one portable local source and documentation context index contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Local source and documentation context index. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/context/__init__.py; tina4_python/context/chunker.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
