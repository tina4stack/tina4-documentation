# Feature 094: Document store interface

## Identity and status

- Matrix identity: 94 — Document store interface
- Audit state: queued
...
- Catalog phase: Document storage

## Why this feature exists

This feature gives an application one portable document store interface contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Document store interface. The
