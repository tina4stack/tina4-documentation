# Feature 070: Memcached session provider

## Identity and status

- Matrix identity: 70 — Memcached session provider
- Audit state: queued
...
This feature gives an application one portable memcached session provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Memcached session provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/session_handlers/memcached_handler.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
