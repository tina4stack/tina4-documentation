# Feature 074: Redis cache provider

## Identity and status

- Matrix identity: 74 — Redis cache provider
- Audit state: queued
...
This feature gives an application one portable redis cache provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Redis cache provider. The
