# Feature 091: Kafka queue provider

## Identity and status

- Matrix identity: 91 — Kafka queue provider
- Audit state: queued
...
This feature gives an application one portable kafka queue provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Kafka queue provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/queue/kafka_backend.py; tina4_python/queue_backends/kafka_backend.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
