# Feature 116: CLI environment management

## Identity and status

- Matrix identity: 116 — CLI environment management
- Audit state: queued
...
This feature gives an application one portable cli environment management contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI environment management. The
