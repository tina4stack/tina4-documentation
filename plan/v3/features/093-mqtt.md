# Feature 093: MQTT client

## Identity and status

- Matrix identity: 93 — MQTT client
- Audit state: queued
...
This feature gives an application one portable mqtt client contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for MQTT client. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/mqtt/__init__.py; tina4_python/mqtt/message.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
