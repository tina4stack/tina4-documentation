# Feature 047: Frond lexer

## Identity and status

- Matrix identity: 47 — Frond lexer
...
- Historical audit: 2026-07-28, previously bundled with Features 48-50
...
Feature 47 owns source tokenization, token positions, lexical errors, whitespace
controls and the token stream passed to Feature 48. It does not own AST
