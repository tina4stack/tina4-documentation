# Feature 129: Dynamic framework version

## Identity and status

- Matrix identity: 129 — Dynamic framework version
- Audit state: queued
...
This feature gives an application one portable dynamic framework version contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Dynamic framework version. The
