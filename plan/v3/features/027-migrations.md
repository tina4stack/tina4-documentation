# Feature 27: Migrations (run, create, status, rollback)
...
Feature 27 is therefore the next unaudited row. This audit covers SQL and
code migrations, discovery/order, the tracking table, apply/status/rollback,
startup auto-migrate, and the public `Migration` surface.
