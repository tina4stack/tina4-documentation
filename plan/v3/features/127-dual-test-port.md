# Feature 127: Dual development and test ports

## Identity and status

- Matrix identity: 127 — Dual development and test ports
- Audit state: queued
...
This feature gives an application one portable dual development and test ports contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Dual development and test ports. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/core/server.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
