# Feature 065: File session provider

## Identity and status

- Matrix identity: 65 — File session provider
- Audit state: queued
...
This feature gives an application one portable file session provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for File session provider. The
