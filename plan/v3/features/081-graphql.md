...
This feature gives an application one portable graphql contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for GraphQL. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/graphql/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
