# Feature 056: Frond auto-escaping

## Identity and status

- Matrix identity: 56 — Frond auto-escaping
...
Features 47-50 flagged it as the highest-risk part of the ADR-0009 folder split. Knowing its
current state matters before anyone moves the code that decides what gets escaped.

### Note on the ADR-0009 split

Features 47-50 identified auto-escaping as the highest-risk part of the folder split.
