# Feature 053: Frond expression tests

## Identity and status

- Matrix identity: 53 — Frond expression tests
- Audit state: queued
...
This feature gives an application one portable frond expression tests contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Frond expression tests. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/frond/engine.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
