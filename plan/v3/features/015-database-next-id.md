# Feature 015: Race-safe database sequences

## Identity and status

- Matrix identity: 15 — Race-safe database sequences
- Audit state: queued
...
This feature gives an application one portable race-safe database sequences contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Race-safe database sequences. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/database/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
