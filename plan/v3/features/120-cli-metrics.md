# Feature 120: CLI code metrics

## Identity and status

- Matrix identity: 120 — CLI code metrics
- Audit state: queued
...
This feature gives an application one portable cli code metrics contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI code metrics. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/cli/__init__.py; tina4_python/dev_admin/metrics.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
