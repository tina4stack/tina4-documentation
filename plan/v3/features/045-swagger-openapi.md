...
- Dependencies: Feature 1 configuration, Feature 30 responses and Feature 31 routes
...
Feature 45 owns OpenAPI document generation, route/schema/security metadata,
the configured description and the enable/serve policy for Swagger UI. Routes
belong to Feature 31 and response delivery belongs to Feature 30.
