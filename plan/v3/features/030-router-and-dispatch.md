# Feature 030: Router and dispatch

## Identity and status

- Matrix identity: 30 — Router and dispatch
...
- Dependants: Feature 32 middleware, Feature 37 health, Feature 33 CORS,
...
Feature 30 is **not stable**. The original fixture checker is green, but it only
...
- middleware hook semantics to Feature 32;
- health payloads to Feature 37;
- CORS policy to Feature 33;
...
These close the DESIGN half of the FINAL bar for Feature 30. Remaining to reach
...
A clean-room language port implements Feature 30 in this order:
...
Feature 30 is **audit-complete and decision-ready**, not implementation-complete
