# Feature 115: CLI interactive console

## Identity and status

- Matrix identity: 115 — CLI interactive console
- Audit state: queued
...
This feature gives an application one portable cli interactive console contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI interactive console. The
