# Feature 120: CLI code generation

## Identity and status

- Matrix identity: 120 — CLI code generation
- Audit state: queued
...
This feature gives an application one portable cli code generation contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI code generation. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/cli/__init__.py; tina4_python/templates/` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
