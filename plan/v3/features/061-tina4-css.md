# Feature 061: Tina4 CSS

## Identity and status

- Matrix identity: 61 — Tina4 CSS
- Audit state: queued
...
This feature gives an application one portable tina4 css contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Tina4 CSS. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/public/css/; tina4_python/scss/` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
