# Feature 104: Dependency injection container

## Identity and status

- Matrix identity: 104 — Dependency injection container
- Audit state: queued
...
This feature gives an application one portable dependency injection container contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Dependency injection container. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/container/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
