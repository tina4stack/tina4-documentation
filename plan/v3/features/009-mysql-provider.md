# Feature 009: MySQL provider

## Identity and status

- Matrix identity: 9 — MySQL provider
- Audit state: queued
...
This feature gives an application one portable mysql provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for MySQL provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/database/mysql.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
