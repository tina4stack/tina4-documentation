# Feature 058: Frond template caching

## Identity and status

- Matrix identity: 58 — Frond template caching
...
- Dependencies: Features 47-50 and the Feature 71 cache-provider contract

Feature 58 owns compiled-template cache identity, freshness, invalidation,
development behavior, concurrency and bounds. It does not own fragment output
caching (Feature 59), general KV backends (Feature 71) or HTTP response caching.
