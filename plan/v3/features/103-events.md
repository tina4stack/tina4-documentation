# Feature 103: Event and listener system

## Identity and status

- Matrix identity: 103 — Event and listener system
- Audit state: queued
...
This feature gives an application one portable event and listener system contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Event and listener system. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/core/events.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
