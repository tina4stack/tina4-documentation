# Feature 089: Lite queue provider

## Identity and status

- Matrix identity: 89 — Lite queue provider
- Audit state: queued
...
This feature gives an application one portable lite queue provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Lite queue provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/queue/lite_backend.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
