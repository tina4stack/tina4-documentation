# Feature 068: MongoDB session provider

## Identity and status

- Matrix identity: 68 — MongoDB session provider
- Audit state: queued
...
This feature gives an application one portable mongodb session provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for MongoDB session provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/session_handlers/mongodb_handler.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
