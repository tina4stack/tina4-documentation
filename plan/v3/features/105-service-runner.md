# Feature 105: Service runner

## Identity and status

- Matrix identity: 105 — Service runner
- Audit state: queued
...
This feature gives an application one portable service runner contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Service runner. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/service/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
