# Feature 097: Realtime collaboration

## Identity and status

- Matrix identity: 97 — Realtime collaboration
- Audit state: queued
...
This feature gives an application one portable realtime collaboration contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Realtime collaboration. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/realtime/__init__.py; tina4_python/realtime/models/` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
