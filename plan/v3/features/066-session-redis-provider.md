# Feature 066: Redis session provider

## Identity and status

- Matrix identity: 66 — Redis session provider
- Audit state: queued
...
This feature gives an application one portable redis session provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Redis session provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/session_handlers/redis_handler.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
