# Feature 125: CLI deployment

## Identity and status

- Matrix identity: 125 — CLI deployment
- Audit state: queued
...
This feature gives an application one portable cli deployment contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI deployment. The
