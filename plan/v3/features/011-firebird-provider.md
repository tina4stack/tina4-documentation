# Feature 011: Firebird provider

## Identity and status

- Matrix identity: 11 — Firebird provider
- Audit state: queued
...
This feature gives an application one portable firebird provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Firebird provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/database/firebird.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
