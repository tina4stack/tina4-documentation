# Feature 131: Inline testing API

## Identity and status

- Matrix identity: 131 — Inline testing API
- Audit state: queued
...
This feature gives an application one portable inline testing api contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Inline testing API. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/Testing.py; tina4_python/test/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
