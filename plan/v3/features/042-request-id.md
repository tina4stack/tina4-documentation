# Feature 042: Request ID tracking

## Identity and status

- Matrix identity: 42 — Request ID tracking
- Audit state: queued
...
This feature gives an application one portable request id tracking contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Request ID tracking. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/core/request.py; tina4_python/core/server.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
