# Feature 095: SQLite document store provider

## Identity and status

- Matrix identity: 95 — SQLite document store provider
- Audit state: queued
...
This feature gives an application one portable sqlite document store provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for SQLite document store provider. The
