# Feature 098: Local realtime attachment storage

## Identity and status

- Matrix identity: 98 — Local realtime attachment storage
- Audit state: queued
...
This feature gives an application one portable local realtime attachment storage contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Local realtime attachment storage. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/realtime/storage.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
