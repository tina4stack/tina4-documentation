# Feature 114: CLI route inspection

## Identity and status

- Matrix identity: 114 — CLI route inspection
- Audit state: auditing
- Audit note: Structure migrated; closure checklist records remaining work
- Dependencies: Feature 30 router/dispatch and Feature 31 route groups
...
Feature 114 owns application boot and discovery for inspection, human and
machine output, route order, middleware/auth visibility and CLI exit behavior.
Matching belongs to Feature 30 and group composition belongs to Feature 31.
