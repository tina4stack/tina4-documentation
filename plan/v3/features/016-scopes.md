# Feature 16: Scopes (reusable query filters)
...
Scopes live in the ORM base class; measurements are feature 13's.
...
This row plus feature 15 plus a prior fix make a pattern the audit should name.
