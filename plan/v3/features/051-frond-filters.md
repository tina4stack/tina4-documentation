# Feature 051: Frond filters

## Identity and status

- Matrix identity: 51 — Frond filters
...
surface. Backed by the byte-identical 82-case expression corpus (Features 47-50), filter
...
3. **The filter registry is data, not control flow.** This is the Features 47-50 finding
