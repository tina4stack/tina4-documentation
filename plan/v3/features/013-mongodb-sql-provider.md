# Feature 013: MongoDB SQL-translation provider

## Identity and status

- Matrix identity: 13 — MongoDB SQL-translation provider
- Audit state: queued
...
This feature gives an application one portable mongodb sql-translation provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for MongoDB SQL-translation provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/database/mongodb.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
