# Feature 028: HTTP request model

## Identity and status

- Matrix identity: 28 — HTTP request model
- Audit state: queued
...
- Catalog phase: HTTP core

## Why this feature exists

This feature gives an application one portable http request model contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for HTTP request model. The
