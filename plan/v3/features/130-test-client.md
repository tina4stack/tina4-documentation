# Feature 130: In-process HTTP test client

## Identity and status

- Matrix identity: 130 — In-process HTTP test client
- Audit state: queued
...
- Catalog phase: Testing tools

## Why this feature exists

This feature gives an application one portable in-process http test client contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for In-process HTTP test client. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/test_client/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
