# Feature 109: CLI project initialization

## Identity and status

- Matrix identity: 109 — CLI project initialization
- Audit state: queued
...
This feature gives an application one portable cli project initialization contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI project initialization. The
