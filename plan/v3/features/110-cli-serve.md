# Feature 110: CLI development server

## Identity and status

- Matrix identity: 110 — CLI development server
- Audit state: queued
...
This feature gives an application one portable cli development server contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CLI development server. The
