# Feature 036: CSRF protection

## Identity and status

- Matrix identity: 36 — CSRF protection
- Audit state: queued
...
This feature gives an application one portable csrf protection contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for CSRF protection. The
