# Feature 050: Frond runtime

## Identity and status

- Matrix identity: 50 — Frond runtime
...
- Historical audit: 2026-07-28, previously bundled with Features 47-49
...
Feature 50 owns context lookup, scopes, inheritance state, macro and block calls,
