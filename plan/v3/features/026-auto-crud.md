# Feature 026: Automatic CRUD from models

## Identity and status

- Matrix identity: 26 — Automatic CRUD from models
- Audit state: queued
...
This feature gives an application one portable automatic crud from models contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Automatic CRUD from models. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/crud/__init__.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
