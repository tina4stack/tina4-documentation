# Feature 092: MongoDB queue provider

## Identity and status

- Matrix identity: 92 — MongoDB queue provider
- Audit state: queued
...
This feature gives an application one portable mongodb queue provider contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for MongoDB queue provider. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/queue/mongo_backend.py; tina4_python/queue_backends/mongo_backend.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
