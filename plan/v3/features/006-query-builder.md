# Feature 006: Query builder and SQL translation

## Identity and status

- Matrix identity: 6 — Query builder and SQL translation
- Audit state: queued
...
This feature gives an application one portable query builder and sql translation contract across
every Tina4 language.

## Boundary

This packet owns the public behavior and integration boundary for Query builder and SQL translation. The
...
| --- | --- | --- | --- | --- |
| Public surface | `tina4_python/query_builder/__init__.py; tina4_python/database/sql_translator.py` | Not yet inventoried | Not yet inventoried | Not yet inventoried |
