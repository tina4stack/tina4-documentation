...
| B | Docker Hub credentials for the missing 3.13.94 images | Credentials live on the **lab host** server; images can be built and pushed from there. | Build + push the four 3.13.94 images from that host. NOT yet done. |
