...
- SKILL DRIFT (report-a-skill FILED on tina4-documentation 2026-08-12): remove the `render_production_error` "Production error" row from `references/subsystems.md` in ALL FOUR repos' tina4-maintainer skill (the fn was deleted in feature 126). MUST DO right after feature 132 lands - those four framework trees have a live worker (132) right now; this is the fix-on-discovery live-collision exception, sequenced immediately after. Do NOT drop.
