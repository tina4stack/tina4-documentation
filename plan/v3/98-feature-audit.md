...
| 28-31 | Frond engine (lexer/parser/compiler/runtime) | PROMOTE python (structure) | SOLID | `features/028-frond-lexer.md`, `features/029-frond-parser.md`, `features/030-frond-compiler.md`, `features/031-frond-runtime.md` | historical closure split into four queued packets |
